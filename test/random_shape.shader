Shader "Custom/Random2BitShapeShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // シェイプの位置と変形を計算
            float2 transformShape(float2 uv, float id)
            {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                // UVを変形
                float2 transformedUV = transformShape((localUV - 0.5) / size + 0.5, cellID);
                ...
                finalColor.rgb = lerp(_BackgroundColor.rgb, shapeColor * pulse, 
                    shapeSample.r * edgeMask * _Opacity);
                finalColor.a = shapeSample.r * edgeMask * _Opacity;
